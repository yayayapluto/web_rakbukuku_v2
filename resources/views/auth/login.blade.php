                ...
                <div class="w-full p-10 sm:p-12.5 xl:p-17.5">
                    ...
                    <form>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="email" name="email" id="input_email" placeholder="Enter your email"
                                    class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="input_password" placeholder="6+ Characters, 1 Capital letter"
                                    class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none" required />
                            </div>
                        </div>
