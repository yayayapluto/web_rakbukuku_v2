...
<div class="fixed bottom-10 left-0 right-0 w-full bg-white ">
    <div class="mx-auto w-[1216px] h-[150px] bg-white drop-shadow-2xl rounded-xl">
        <div class="flex items-center gap-4 h-full p-4">
            ...
            <!-- Add to Cart Button -->
            <div class="ml-auto">
                <a class="bg-[#0060AE] hover:bg-[#004681] active:bg-[#003561] text-white py-3 px-4 text-sm font-bold  w-[186px] flex justify-center items-center gap-2 rounded-xl" href="{{route("borrow.form")}}">
